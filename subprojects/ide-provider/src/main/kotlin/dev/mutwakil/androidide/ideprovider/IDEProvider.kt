 ...
 */
package dev.mutwakil.androidide.ideprovider

import com.google.gson.Gson
import com.google.gson.JsonObject
import com.google.gson.JsonParser
import dev.mutwakil.androidide.ideprovider.models.IDEConfig
import dev.mutwakil.androidide.ideprovider.models.PackageEntry
import dev.mutwakil.androidide.ideprovider.utils.DownloadCallback
import dev.mutwakil.androidide.ideprovider.utils.HashUtils
import dev.mutwakil.androidide.utils.Environment.TMP_DIR as TMPDIR
import java.io.File
...
class IDEProvider(
  ...
  private val logger = LoggerFactory.getLogger(IDEProvider::class.java)
  ...
  fun findPackageEntry(jsonContent: String, config: IDEConfig): PackageEntry {
  ...
  suspend fun getField(config: IDEConfig): String =
      withContext(Dispatchers.IO) {
  ...
  suspend fun downloadPackage(config: IDEConfig, callback: DownloadCallback? = null): File =
      withContext(Dispatchers.IO) {
  ...
  suspend fun execute(config: IDEConfig, callback: DownloadCallback? = null): Any =
      withContext(Dispatchers.IO) {
