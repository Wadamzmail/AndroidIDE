package dev.mutwakil.androidide.layouteditor.editor.dialogs;
...
import dev.mutwakil.androidide.layouteditor.databinding.LayoutColorDialogBinding;
import dev.mutwakil.androidide.layouteditor.views.ColorView;
...
public class ColorDialog extends AttributeDialog
  ...
  public ColorDialog(Context context, String savedValue) {
    ...
    dev.mutwakil.androidide.layouteditor.databinding.LayoutColorDialogBinding binding = LayoutColorDialogBinding.inflate(getDialog().getLayoutInflater());
