package dev.mutwakil.androidide.vectormaster.models;
...
import dev.mutwakil.androidide.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (pathData != null) {
      if (useLegacyParser) {
        originalPath =
            dev.mutwakil.androidide.vectormaster.utilities.legacyparser.PathParser
