...
public class ThemeUtils {
  ...
  /**
   * Will return true if mode is set to {@link NightMode#TRUE}, otherwise will return true if mode
   ...
   *                {@link AppCompatActivity} or one with which a theme attribute can be got. Do no
