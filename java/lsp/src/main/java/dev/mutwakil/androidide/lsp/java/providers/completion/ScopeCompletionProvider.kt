...
import dev.mutwakil.androidide.lsp.java.edits.MultipleClassImportEditHandler
import dev.mutwakil.androidide.lsp.java.models.JavaCompletionItem
import dev.mutwakil.androidide.lsp.java.utils.JavaPoetUtils.Companion.buildMethod
import dev.mutwakil.androidide.lsp.java.utils.JavaPoetUtils.Companion.print
import dev.mutwakil.androidide.lsp.java.utils.ScopeHelper
...
class ScopeCompletionProvider(
  ...
  private fun overrideIfPossible(
    ...
    item.completionKind = dev.mutwakil.androidide.lsp.models.CompletionItemKind.METHOD
