...
import dev.mutwakil.androidide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: dev.mutwakil.androidide.utils.ClassTrie, pkgName: String): Node? {
