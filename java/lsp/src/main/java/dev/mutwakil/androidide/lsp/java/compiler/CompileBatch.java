...
import static dev.mutwakil.androidide.javac.config.JavacConfigProvider.setLatestSourceVersion;
import static dev.mutwakil.androidide.javac.config.JavacConfigProvider.setLatestSupportedSourceVersion;
import static dev.mutwakil.androidide.utils.Environment.JAVA_HOME;
...
import dev.mutwakil.androidide.preferences.internal.JavaPreferences;
...
//    updatePositions(root, false);
    ...
    private List<String> options() {
        ...
        //expermintal
        if (BaseApplication.getBaseInstance().getPrefManager().getBoolean(JavaPreferences.JAVA_PREVIEW_FEATURES_ENABLED, false))
