...
import dev.mutwakil.androidide.lsp.java.Rewrite.ConvertVariableToStatement
...
class VariableToStatementAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (!data.hasRequiredData(dev.mutwakil.androidide.lsp.models.DiagnosticItem::class.java)) {
      markInvisible()
      return
    }

    val diagnostic = data.get(dev.mutwakil.androidide.lsp.models.DiagnosticItem::class.java)!!
