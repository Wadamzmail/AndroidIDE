...
import dev.mutwakil.androidide.lsp.java.actions.FieldBasedAction
import dev.mutwakil.androidide.lsp.java.compiler.CompileTask
import dev.mutwakil.androidide.lsp.java.utils.EditHelper
import dev.mutwakil.androidide.lsp.java.utils.ShortTypePrinter.NO_PACKAGE
...
class GenerateConstructorAction : FieldBasedAction() {
  ...
  private fun generateForFields(
    ...
    val stopWatch = dev.mutwakil.androidide.utils.StopWatch("generateConstructorForFields()")
    val constructor =
