...
import dev.mutwakil.androidide.eventbus.events.editor.DocumentSelectedEvent
import dev.mutwakil.androidide.javac.services.fs.CacheFSInfoSingleton
import dev.mutwakil.androidide.javac.services.fs.CachingJarFileSystemProvider.clearCache
import dev.mutwakil.androidide.javac.services.fs.CachingJarFileSystemProvider.clearCachesForPaths
...
import dev.mutwakil.androidide.lsp.internal.model.CachedCompletion
import dev.mutwakil.androidide.lsp.java.actions.JavaCodeActionsMenu
import dev.mutwakil.androidide.lsp.java.compiler.JavaCompilerService
import dev.mutwakil.androidide.lsp.java.compiler.SourceFileManager
import dev.mutwakil.androidide.lsp.java.models.JavaServerSettings
import dev.mutwakil.androidide.lsp.java.providers.CodeFormatProvider
import dev.mutwakil.androidide.lsp.java.providers.CompletionProvider
import dev.mutwakil.androidide.lsp.java.providers.DefinitionProvider
import dev.mutwakil.androidide.lsp.java.providers.JavaDiagnosticProvider
import dev.mutwakil.androidide.lsp.java.providers.JavaSelectionProvider
import dev.mutwakil.androidide.lsp.java.providers.ReferenceProvider
import dev.mutwakil.androidide.lsp.java.providers.SignatureProvider
import dev.mutwakil.androidide.lsp.java.providers.snippet.JavaSnippetRepository.init
import dev.mutwakil.androidide.lsp.java.utils.AnalyzeTimer
import dev.mutwakil.androidide.lsp.java.utils.CancelChecker.Companion.isCancelled
...
import dev.mutwakil.androidide.lsp.models.FailureType
...
class JavaLanguageServer : ILanguageServer {
    ...
    override fun setupWithProject(workspace: Workspace) {
        ...
        (ProjectManagerImpl.getInstance().indexingServiceManager.getService(
            JvmLibraryIndexingService.ID
        ) as? JvmLibraryIndexingService?)?.refresh()
