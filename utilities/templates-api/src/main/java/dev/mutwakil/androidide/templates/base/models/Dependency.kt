...
package dev.mutwakil.androidide.templates.base.models

import dev.mutwakil.androidide.templates.base.models.DependencyConfiguration.DebugImplementation
...
data class Dependency(val configuration: DependencyConfiguration,
  ...
  object AndroidX {
    ...
    private const val navigationVersion = "2.9.7"
    ...
    object Compose {
      ...
      @JvmStatic
      val Core_Ktx = parseDependency("androidx.core:core-ktx:1.18.0")
      ...
      @JvmStatic
      val Activity = parseDependency("androidx.activity:activity-compose:1.12.4")

      @JvmStatic
      val BOM = parseDependency("androidx.compose:compose-bom:2026.05.01",
        isPlatform = true)
