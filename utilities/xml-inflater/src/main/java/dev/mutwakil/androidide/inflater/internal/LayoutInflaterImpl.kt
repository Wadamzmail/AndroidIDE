...
package dev.mutwakil.androidide.inflater.internal
...
import dev.mutwakil.androidide.inflater.DefaultComponentFactory
import dev.mutwakil.androidide.inflater.IAttribute
import dev.mutwakil.androidide.inflater.IComponentFactory
import dev.mutwakil.androidide.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import dev.mutwakil.androidide.inflater.ILayoutInflater
...
import dev.mutwakil.androidide.inflater.InflateException
import dev.mutwakil.androidide.inflater.events.IInflateEventsListener
import dev.mutwakil.androidide.inflater.events.InflationFinishEvent
import dev.mutwakil.androidide.inflater.events.InflationStartEvent
import dev.mutwakil.androidide.inflater.events.OnApplyAttributeEvent
import dev.mutwakil.androidide.inflater.events.OnInflateViewEvent
import dev.mutwakil.androidide.inflater.internal.utils.IDTable
import dev.mutwakil.androidide.inflater.internal.utils.ViewFactory.createViewInstance
import dev.mutwakil.androidide.inflater.internal.utils.ViewFactory.generateLayoutParams
import dev.mutwakil.androidide.inflater.internal.utils.parseLayoutReference
import dev.mutwakil.androidide.inflater.utils.endParse
import dev.mutwakil.androidide.inflater.utils.isParsing
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return dev.mutwakil.androidide.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = dev.mutwakil.androidide.inflater.utils.module
      } else {
