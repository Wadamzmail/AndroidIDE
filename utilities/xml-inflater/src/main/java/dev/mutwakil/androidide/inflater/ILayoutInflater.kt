...
interface ILayoutInflater : Closeable {
   ...
   *
   * **NOTE** : The [startParse][dev.mutwakil.androidide.inflater.utils.startParse] method is called
   * if it hasn't been called yet. However, the [endParse]
   * [dev.mutwakil.androidide.inflater.utils.endParse] method is not called after the parse is done.
   * The caller is expected to call [close] when this inflater instance is no longer needed. The
   * [close] method calls the [endParse] [dev.mutwakil.androidide.inflater.utils.endParse].
   *
