 ...
 * [dev.mutwakil.androidide.lsp.kotlin.compiler.read] lock, so code inside an `analyze` block must never
 * call [dev.mutwakil.androidide.lsp.kotlin.compiler.write] — read → write on the same thread deadlocks.
 */
