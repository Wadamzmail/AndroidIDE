...
import dev.mutwakil.androidide.build.config.AUTH_PASS
import dev.mutwakil.androidide.build.config.AUTH_USER
import dev.mutwakil.androidide.build.config.KEY_BIN
import dev.mutwakil.androidide.build.config.KEY_URL
