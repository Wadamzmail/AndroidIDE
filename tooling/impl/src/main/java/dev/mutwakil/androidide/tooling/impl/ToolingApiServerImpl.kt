...
import dev.mutwakil.androidide.tooling.api.messages.GradleDistributionParams
import dev.mutwakil.androidide.tooling.api.messages.GradleDistributionType
...
import dev.mutwakil.androidide.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
...
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
...
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import dev.mutwakil.androidide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
...
import dev.mutwakil.androidide.tooling.impl.sync.RootProjectModelBuilderParams
import dev.mutwakil.androidide.tooling.impl.util.configureFrom
...
internal class ToolingApiServerImpl : IToolingApiServer {
	...
	override fun shutdown(): CompletableFuture<Void> =
		CompletableFuture.supplyAsync {
			...
			// see dev.mutwakil.androidide.tooling.impl.Main.main(String[])
