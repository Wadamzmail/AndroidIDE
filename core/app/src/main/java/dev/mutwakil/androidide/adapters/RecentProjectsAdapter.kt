...
import dev.mutwakil.androidide.databinding.RenameProjectTextinputBinding
import dev.mutwakil.androidide.databinding.SavedRecentProjectItemBinding
...
import dev.mutwakil.androidide.utils.FileUtils
...
class RecentProjectsAdapter(
	...
	fun renderDate(
		binding: SavedRecentProjectItemBinding,
		project: ProjectFile,
	) {
