...
import dev.mutwakil.androidide.activities.IdeConfigurations.net.isOnline
import dev.mutwakil.androidide.app.BaseApplication
import dev.mutwakil.androidide.app.EdgeToEdgeIDEActivity
import dev.mutwakil.androidide.databinding.ActivityMainCrashBinding
import dev.mutwakil.androidide.handlers.ConfigHandlerRegistry
...
class IDEConfigurations : EdgeToEdgeIDEActivity() {
  ...
  private fun setupHandlerUI(handler: dev.mutwakil.androidide.handlers.IConfigHandler) {
    try {
  ...
  private fun setUpDropdown() {
    ...
    lifecycleScope.launch(Dispatchers.IO) {
      try {
        val versionsResult =
            IdeCommandInterface.listVersions(
