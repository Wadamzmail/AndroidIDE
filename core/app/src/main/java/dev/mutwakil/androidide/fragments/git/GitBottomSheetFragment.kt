package dev.mutwakil.androidide.fragments.git
...
import dev.mutwakil.androidide.activities.PreferencesActivity
import dev.mutwakil.androidide.activities.editor.EditorHandlerActivity
import dev.mutwakil.androidide.databinding.FragmentGitBottomSheetBinding
import dev.mutwakil.androidide.events.ListProjectFilesRequestEvent
import dev.mutwakil.androidide.fragments.git.adapter.GitFileChangeAdapter
...
import dev.mutwakil.androidide.preferences.internal.GitPreferences
...
import dev.mutwakil.androidide.viewmodel.GitBottomSheetViewModel.BranchesUiState
import dev.mutwakil.androidide.viewmodel.GitBottomSheetViewModel.PullUiState
...
class GitBottomSheetFragment : Fragment(R.layout.fragment_git_bottom_sheet) {
	...
	override fun onViewCreated(
		...
		viewLifecycleOwner.lifecycleScope.launch {
			...
			launch {
				viewModel.initError.collectLatest {
					flashError(getString(R.string.git_init_failed))
				}
			}
