...
import dev.mutwakil.androidide.databinding.FragmentSubModuleBinding
import dev.mutwakil.androidide.projects.IProjectManager
import dev.mutwakil.androidide.utils.ModuleCreator
import java.io.File
...
class SubModuleFragment : Fragment() {
  ...
  override fun onDestroy() {
      super.onDestroy()
      dev.mutwakil.androidide.utils.EditorSidebarActions.removeFragmentFromCache("ide.editor.sidebar.subModule")
  }
}