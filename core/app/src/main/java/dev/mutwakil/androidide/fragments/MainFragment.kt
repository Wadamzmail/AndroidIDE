...
import dev.mutwakil.androidide.adapters.MainActionsListAdapter
import dev.mutwakil.androidide.app.BaseApplication
import dev.mutwakil.androidide.app.BaseIDEActivity
import dev.mutwakil.androidide.common.databinding.LayoutDialogProgressBinding
import dev.mutwakil.androidide.databinding.FragmentMainBinding
import dev.mutwakil.androidide.models.MainScreenAction
    ...
    val actions = MainScreenAction.all().also { actions ->
      val onClick = { action: MainScreenAction, _: View ->
        when (action.id) {
          ...
          MainScreenAction.ACTION_DONATE -> BaseApplication.baseInstance.openDonationsPage()
          MainScreenAction.ACTION_DOCS -> BaseApplication.baseInstance.openDocs()
        }
      }
