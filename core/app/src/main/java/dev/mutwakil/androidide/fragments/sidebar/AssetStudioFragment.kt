...
import dev.mutwakil.androidide.activities.AssetStudioActivity
import dev.mutwakil.androidide.activities.ActivityM3Icons
import dev.mutwakil.androidide.databinding.FragmentAssetStudioBinding
...
class AssetStudioFragment : Fragment() {
  ...
  override fun onDestroy() {
      super.onDestroy()
      dev.mutwakil.androidide.utils.EditorSidebarActions.removeFragmentFromCache("ide.editor.sidebar.assetStudio")
  }
}