...
import dev.mutwakil.androidide.eventbus.events.editor.OnCreateEvent
import dev.mutwakil.androidide.eventbus.events.editor.OnDestroyEvent
import dev.mutwakil.androidide.eventbus.events.editor.OnPauseEvent
...
/**
 * Observes lifecycle events if [dev.mutwakil.androidide.EditorActivityKt].
 *
 * @author Akash Yadav
 */
